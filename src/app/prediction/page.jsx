...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    const price_diff = base_price - checkout_price;
...
function getFieldDescription(field) {
  const descriptions = {
    ...
    food: "Food Item mapped to food_id",
    checkout_price: "Price willing to sell/donate",
    base_price: "Original price of the commodity"
  };
